...
const StudentFileUpload = (props) => {
  ...
  const [previewSrc, setPreviewSrc] = useState(''); // state for previewImage storage
  ...
  const [isPreviewAvailable, setIsPreviewAvailable] = useState(false); // specify that only photos should be shown as previews
